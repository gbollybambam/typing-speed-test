...
const ResultsModal = ({ status, wpm, accuracy, correctChars, errorChars, history, resultMessage, onRestart }: ResultsModalProps) => {
  ...
  return (
    // UPDATED: Variable background
    <div className="fixed inset-0 bg-[var(--bg-primary)] z-40 flex flex-col items-center justify-center p-6 animate-in fade-in duration-200 overflow-y-auto">
